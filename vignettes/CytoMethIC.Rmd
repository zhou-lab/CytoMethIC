...
cmi_classify(betas, ExperimentHub()[["EH8395"]])
cmi_classify(betas, ExperimentHub()[["EH8396"]])
```
...
betas <- sesameDataGet("HM450.1.TCGA.PAAD")$betas
cmi_classify(betas, ExperimentHub()[["EH8422"]])
```
...
betas <- sesameDataGet("HM450.1.TCGA.PAAD")$betas
cmi_classify(betas, ExperimentHub()[["EH8421"]])
```
...
betas <- sesameDataGet("HM450.1.TCGA.PAAD")$betas
cmi_classify(betas, ExperimentHub()[["EH8423"]])
```
